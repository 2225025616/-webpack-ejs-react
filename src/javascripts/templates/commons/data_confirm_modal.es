...
(function ($) {
  ...
  var buildModal = function (options) {
      ...
      '<div id="'+id+'" class="modal '+fade+' '+modalClass+'" tabIndex="-1" role="dialog" aria-labelledby="'+id+'Label" aria-hidden="true">' +
        '<div class="modal-dialog">' +
          '<div class="modal-content">' +
            '<div class="modal-header.es">' +
               (options.close ? '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>' : '') +
    ...
    var highest = settings.zIndex;
    var current = settings.zIndex;
