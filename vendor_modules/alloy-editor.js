    ...
    var AlloyEditor = {
        ...
        loadLanguageResources: function loadLanguageResources(callback) {
            ...
            if (!AlloyEditor._langResourceRequested) {
                ...
                if (languages.indexOf( lang + '-' + locale )) {
                    lang = lang + '-' + locale;
    ...
    Table.prototype = {
        ...
        getHeading: function getHeading(table) {
            ...
            for (var row = 0; row < table.$.rows.length; row++) {
                // If just one cell isn't a TH then it isn't a Header.es column
...
(function () {
    ...
    /**
     * The ButtonsStylesListHeader class provides the Header.es of an list of style items.
     *
...
(function () {
    ...
    var ButtonTableColumn = React.createClass({
        ...
        propTypes: {
            ...
            /**
             * The tabIndex of the button in its toolbar current state. A value others than -1
             * means that the button has focus and is the active element.
             *
             * @property {Number} tabIndex
             */
